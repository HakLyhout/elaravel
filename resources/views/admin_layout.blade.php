			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/categories')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="{{URL::to('/all-brand')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
						<li><a href="{{URL::to('/brand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brands</span></a></li>
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Products</span></a></li>
								<li><a class="submenu" href="{{URL::to('/all-product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Products</span></a></li>
							</ul>	
						</li>
						<li><a href="form.html"><i class="icon-edit"></i><span class="hidden-tablet"> Slides</span></a></li>
						<li><a href="chart.html"><i class="icon-list-alt"></i><span class="hidden-tablet"> Social Link</span></a></li>
						<li><a href="{{URL::to('/manage_order')}}"><i class="icon-font"></i><span class="hidden-tablet"> Shipping</span></a></li>
