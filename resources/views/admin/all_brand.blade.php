						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									@if($v_brand->publication_status == 1)
										<a class="btn btn-success" href="{{ URL::to('/unactive_brand/'.$v_brand->manufacture_id)}}">
											<i class="halflings-icon white thumbs-down"></i>  
										</a>
									@else
										<a class="btn btn-danger" href="{{ URL::to('/active_brand/'.$v_brand->manufacture_id)}}">
									...
									@endif
										...
										<a class="btn btn-danger" id="delete" href="{{ URL::to('/delete_brand/'.$v_brand->manufacture_id)}}">
